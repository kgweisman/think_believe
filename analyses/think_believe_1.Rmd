...
ggsave("../figures/cogsci2020/fig01.png")
```
...
```{r}
bind_rows(regtab_fun(r1.6_eng, std_beta = T) %>% 
            mutate(Language = "English"),
          regtab_fun(r1.6_noeng, std_beta = T) %>% 
...
```{r}
bind_rows(regtab_fun(r1.8_eng_gh, std_beta = T) %>% 
            mutate(Country = "Ghana", Language = "English"),
          regtab_fun(r1.8_noeng_gh, std_beta = T) %>% 
            mutate(Country = "Ghana", Language = "No English"),
          regtab_fun(r1.8_eng_th, std_beta = T) %>% 
            mutate(Country = "Thailand", Language = "English"),
          regtab_fun(r1.8_noeng_th, std_beta = T) %>% 
            mutate(Country = "Thailand", Language = "No English"),
          regtab_fun(r1.8_eng_vt, std_beta = T) %>% 
            mutate(Country = "Vanuatu", Language = "English"),
          regtab_fun(r1.8_noeng_vt, std_beta = T) %>% 
...
```{r}
bind_rows(regtab_fun(r1.9_eng, std_beta = T) %>% 
            mutate(Language = "English"),
          regtab_fun(r1.9_noeng, std_beta = T) %>% 
            mutate(Language = "No English")) %>%
  select(Language, everything()) %>%
