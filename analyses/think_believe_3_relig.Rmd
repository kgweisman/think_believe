...
d3_temp <- d3_long %>%
  ...
  mutate(relig_cat = case_when(
    thb3_religion == "Christian" | religion == "Christian" ~ "Christian",
    grepl("Other", thb3_religion) | 
      grepl("Other", religion) |
      grepl("Buddh", thb3_religion) | 
      grepl("Buddh", religion) ~ "Buddhist/Other",
    thb3_religion == "Not religious" | is.na(thb3_religion) |
...
sample_size_d3_temp <- d3_temp %>%
  distinct(country, thb3_subj, relig_cat) %>%
...
```{r}
r3.9_us <- lmer(believe ~ super_cat * relig_cat
