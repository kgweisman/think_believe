...
Note: We have used a combination of automatic "lemmatization" and hand-coding to do my best to code whether responses should count as "believe" (e.g., including obvious cases like "believes" and "believed"; including Bislama "belif" and "bilif" and other spellings).
...
ggsave("../figures/journal_submission/fig_2.pdf")
```
...
d2_long %>%
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),
        legend.position = "top") +
  labs(x = "Word stem", y = "Percent of responses", fill = "Response type")
# ggsave("../figures/journal_submission/fig_s2.pdf")
```
...
d2_long %>%
  ...
  geom_bar(position = "fill", alpha = 0.7, color = "black", size = 0.2) +
  scale_y_continuous(labels = scales::percent) +
